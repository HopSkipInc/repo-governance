...
| HopSkipInc/ai-fleet | [2026-08-07 generated system maps](2026-08-07-graphify-system-maps.md) | pending — graphify install; commit-back path decision recorded in the installing PR |
...
| HopSkipInc/ai-fleet | [2026-08-08 enforcement stanzas](2026-08-08-enforcement-stanzas.md) | pending — stanza pair + assertion lint in one PR; **merge** into existing `.claude/settings.json` (hooks-only today); lint home is `host/scripts/`, wired into `run-tests.yml` |
