<!-- template: configuration-governance.md v1.0.2 · updated 2026-09-26 -->
...
| Version | Date | Change |
|---|---|---|
| 1.0.2 | 2026-09-26 | §11's ninth-audit-domain row flips to **Shipped** — `audit-domains.md` v1.0.1 defines it — so the intro returns to "three of the four" and the Status line distinguishes the shipped domain from the unshipped lint |
