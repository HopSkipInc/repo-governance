<!-- template: harness-enforcement.opencode.md v1.2.0 · updated 2026-09-15 -->
...
## Mediated write paths (v1.2.0, issue #104; v1.1.0, issue #81)
...
- **`append-row` (issue #104) covers the singleton living-document records** —
  ...
  revised file, so there is nothing for a guard to diff. `docs/agent-routing-
  records.md` is deliberately not covered — its calibration set stays by-hand.
